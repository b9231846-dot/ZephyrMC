...
private fun getZephyrTechnicalInfo(context: Context): List<Pair<String, String>> {
    val packageInfo = try {
    ...
    ElevatedCard(
        ...
        Row(
            ...
            Column(
                ...
                Text(
                    stringResource(R.string.about_zephyr),
                ...
                Column(
                    ...
                    Text(
                        stringResource(R.string.zephyr_introduction),
                        style = MaterialTheme.typography.bodyLarge,
                        color = MaterialTheme.colorScheme.onSurface
                    )

                    Text(
                        stringResource(R.string.zephyr_expectation),
                        style = MaterialTheme.typography.bodyLarge,
                        color = MaterialTheme.colorScheme.onSurface
                    )

                    Text(
                        stringResource(R.string.zephyr_compatibility),
                        style = MaterialTheme.typography.bodyLarge,
                        color = MaterialTheme.colorScheme.onSurface
                    )
                }
                ...
                Text(
                    stringResource(R.string.zephyr_copyright),
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                )

                Text(
                    stringResource(R.string.zephyr_team),
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                )
            ...
            Column(
                ...
                Column(
                    ...
                    getZephyrTechnicalInfo(context).forEach { (key, value) ->
