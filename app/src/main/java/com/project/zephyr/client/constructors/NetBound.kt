...
import com.project.zephyr.client.game.entity.EntityUnknown
import com.project.zephyr.client.game.entity.LocalPlayer
import com.project.zephyr.client.game.entity.MobList
import com.project.zephyr.client.game.event.EventManager
import com.project.zephyr.client.game.event.EventPacketInbound
import com.project.zephyr.client.game.registry.BlockMapping
import com.project.zephyr.client.game.registry.BlockMappingProvider
import com.project.zephyr.client.game.world.Level
import com.project.zephyr.client.game.world.World
import com.project.zephyr.client.overlay.manager.OverlayManager
import com.project.zephyr.client.overlay.mods.MiniMapOverlay
import com.project.zephyr.client.overlay.mods.OverlayModuleList
import com.project.zephyr.client.overlay.mods.PacketNotificationOverlay
import com.project.zephyr.client.overlay.mods.Position
import com.project.zephyr.client.overlay.mods.SessionStatsOverlay
import com.project.zephyr.client.overlay.mods.SpeedometerOverlay
import com.project.zephyr.relay.ZephyrRelaySession
import com.project.zephyr.client.game.registry.ItemMapping
import com.project.zephyr.client.game.registry.ItemMappingProvider
import com.project.zephyr.client.game.registry.LegacyBlockMapping
import com.project.zephyr.client.game.registry.LegacyBlockMappingProvider
import com.project.zephyr.client.overlay.mods.KeystrokesOverlay
import com.project.zephyr.client.overlay.mods.TargetHudOverlay
import com.project.zephyr.client.overlay.mods.TopCenterOverlayNotification
import com.project.zephyr.client.overlay.mods.SelectedMobDialogOverlay
...
class NetBound(val ZephyrRelaySession: ZephyrRelaySession) : ComposedPacketHandler, com.project.zephyr.client.game.event.Listenable {
    ...
    val protocolVersion: Int
        get() = ZephyrRelaySession.server.codec.protocolVersion
    ...
    fun clientBound(packet: BedrockPacket) {
        ZephyrRelaySession.clientBound(packet)
    }

    fun serverBound(packet: BedrockPacket) {
        ZephyrRelaySession.serverBound(packet)
    }
        ...
        when (packet) {
            is StartGamePacket -> {
                ...
                try {
                    ...
                    ZephyrRelaySession.server.peer.codecHelper.itemDefinitions = itemDefinitions
                    ZephyrRelaySession.client?.peer?.codecHelper?.itemDefinitions = itemDefinitions
                ...
                if (!startGameReceived) {
                    ...
                    showToast("Welcome To Zephyr v4", "Connected ${gameDataManager.getLevelName()}")
