...
Java_com_project_zephyr_client_util_HashCat_getSignaturesSha1(
        JNIEnv *env,
        jobject,
...
Java_com_project_zephyr_client_util_HashCat_checkSha1(
        JNIEnv *env,
        jobject,
        jobject contextObject) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_project_zephyr_client_util_HashCat_getToken(
        JNIEnv *env,
        jobject,
        jobject contextObject,
        jstring userId) {
