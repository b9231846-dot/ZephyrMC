...
Java_com_project_zephyr_relay_ZephyrRelay_getNativeDefaultIp(JNIEnv* env, jclass clazz) {
    return createJavaString(env, "0.0.0.0");
}

extern "C" JNIEXPORT jint JNICALL
Java_com_project_zephyr_relay_ZephyrRelay_getNativeDefaultPort(JNIEnv* env, jclass clazz) {
    return 19132;
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_project_zephyr_relay_ZephyrRelay_getNativeRemoteIp(JNIEnv* env, jclass clazz) {
    return createJavaString(env, "geo.hivebedrock.network");
}

extern "C" JNIEXPORT jint JNICALL
Java_com_project_zephyr_relay_ZephyrRelay_getNativeRemotePort(JNIEnv* env, jclass clazz) {
    return 19132;
}

extern "C" JNIEXPORT jobject JNICALL
Java_com_project_zephyr_relay_ZephyrRelay_createNativeAdvertisement(JNIEnv* env, jclass clazz) {
