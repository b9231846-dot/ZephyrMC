...
![Zephyr Client Logo](./images/zephyr.png)  
[![Download count](https://img.shields.io/github/downloads/TheProjectLumina/ZephyrClient/total.svg)](https://github.com/TheProjectLumina/ZephyrClient/releases)[![Netlify Status](https://api.netlify.com/api/v1/badges/679c08db-f713-4384-b052-1fd2f90d35f3/deploy-status)](https://app.netlify.com/projects/projectlumina/deploys) [![License: GPL v3](https://img.shields.io/badge/License-GPL%20v3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0.html)[![GitHub issues](https://img.shields.io/github/issues/TheProjectLumina/ZephyrClient.svg) ](https://github.com/TheProjectLumina/ZephyrClient/issues)[![GitHub stars](https://img.shields.io/github/stars/TheProjectLumina/ZephyrClient.svg)](https://github.com/TheProjectLumina/ZephyrClient/stargazers)[![IntelliJ IDEA](https://img.shields.io/badge/IntelliJIDEA-000000.svg?logo=intellij-idea&logoColor=white)](https://www.jetbrains.com/idea/)[![Firebase](https://img.shields.io/badge/Firebase-039BE5?logo=Firebase&logoColor=white)](https://firebase.google.com/)[![Android](https://img.shields.io/badge/Android-3DDC84?logo=android&logoColor=white)](https://developer.android.com/studio)
...
Lumina is all about giving Minecraft players the tools they need to shine in PvP. We’ve focused on making it easy to use, fast, and compatible with a range of platforms. The Project Zephyr team is passionate about building a tool that’s both powerful and open for the community to explore and improve. We encourage everyone to use Lumina responsibly, contribute ideas, and join us in making it even better.
...
The Project Zephyr community is growing fast, and we love seeing all the energy and support from everyone! Our [Discord server](https://discord.gg/78bqDpAHmK) is full of people chatting, sharing ideas, and just hanging out every day.
...
- **Minecraft Version**: Minecraft Bedrock Edition 1.26.20 or later is recommended for optimal performance and compatibility.
...
1. **Download the APK**: Head to our [Releases page](https://github.com/TheProjectLumina/ZephyrClient/releases) and download the latest Lumina Client APK.
...
If you encounter issues, visit our [Discord](https://discord.gg/78bqDpAHmK) for support or consult the [NOTICE](https://github.com/TheProjectLumina/ZephyrClient/blob/main/NOTICE) file.
...
1. **Clone the Repository**:
    ...
    ```bash
    git clone https://github.com/TheProjectLumina/ZephyrClient.git
    ```
...
2. **Open in Android Studio**:
   ...
   - Choose the `ZephyrClient` directory and open it.
3. **Replace google-services.json**:
   ...
   - Place the downloaded `google-services.json` file in the `app` directory of the ZephyrClient project, overwriting the dummy file.
   - Ensure the package name in Firebase matches the one in `build.gradle` (e.g., `com.projectlumina.ZephyrClient`).
4. **Sync Gradle**:
...
Refer to inline comments and the [NOTICE](https://github.com/TheProjectLumina/ZephyrClient/blob/main/NOTICE) file for guidance. For advanced development tips, join our [Discord](https://discord.gg/78bqDpAHmK) or check our [YouTube](https://youtube.com/@prlumina) for tutorials.
...
- **Community Standards**: Follow our [Code of Conduct](https://github.com/TheProjectLumina/ZephyrClient/blob/main/CODE_OF_CONDUCT.md) to maintain a respectful environment.
...
- Fork the repository for learning or to create derivative projects, provided you comply with the [GNU GPL v3.0](https://github.com/TheProjectLumina/ZephyrClient/blob/main/LICENSE).

### Prohibited Uses

- Do not distribute modified versions without sharing the source code, as required by the GPL.
- Do not claim Lumina as your own without crediting the Project Zephyr team and its contributors.
...
See the [LICENSE](https://github.com/TheProjectLumina/ZephyrClient/blob/main/LICENSE) and [NOTICE](https://github.com/TheProjectLumina/ZephyrClient/blob/main/NOTICE) files for full details.
...
- **GitHub**: Report issues or suggest enhancements on our [GitHub Issues page](https://github.com/TheProjectLumina/ZephyrClient/issues).

We strive to maintain a welcoming and inclusive community. Please review our [Code of Conduct](https://github.com/TheProjectLumina/ZephyrClient/blob/main/CODE_OF_CONDUCT.md) before participating.
...
- **DeepWiki**: Explore our comprehensive [technical documentation](https://deepwiki.com/TheProjectLumina/ZephyrClient) covering system architecture, relay system, packet processing, game modules, chunk data management, and more.
...
Lumina Client Version 4 is a fork of [MuCuteClient](https://github.com/isuckatcodingfr/MuCuteClient) by SuMuCheng and [Protohax](https://github.com/hax0r31337/ProtoHax) by Haxor, with extensive enhancements by the Project Zephyr team. Copyright © 2026 Project Zephyr, with portions © 2026 MuCuteClient/SuMuCheng and © 2023 Protohax/Haxor.
...
For complete details, see the [LICENSE](https://github.com/TheProjectLumina/ZephyrClient/blob/main/LICENSE) and [NOTICE](https://github.com/TheProjectLumina/ZephyrClient/blob/main/NOTICE) files.

---

## Final Thoughts

Lumina Client is a form of love from the Project Zephyr team, built for Minecraft Bedrock community. We’re excited to see how you use, customize, and contribute to Lumina. Join us on [Discord](https://discord.gg/78bqDpAHmK) or [YouTube](https://youtube.com/@prlumina) to stay connected, share your creations, and help shape the future of Lumina!